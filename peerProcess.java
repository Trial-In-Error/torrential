public class peerProcess {
	...
	public boolean getInteresting(/*sender's peerID*/) {
		return peerDict(peerID).interesting;
	}
	
	public void addInterested(int sPeerID) {
		
		interestedList.add(sPeerID);
	}
	public void removeInterested(int sPeerId) {
		interestedList.remove(sPeerID);
	}
